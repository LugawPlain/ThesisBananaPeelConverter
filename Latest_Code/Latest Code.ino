...
//////////////////////////////////
// 220v relay
const int relayHeater = 0;
const int relayGrinder = 0;
const int relayMixer = 0;
const int relayCooker = 0;
// 12v relay
const int relayMixPump = 0;
// 5v relay 
const int relayTray = 0;
const int relayFan = 0;
const int relayWaterPump;
const int relayFlour = 0;
const int relayBPF = 0;
const int relayHose = 0;
const int relayClose= 0;
// 
